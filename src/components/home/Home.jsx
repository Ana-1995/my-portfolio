  ...
  return (
    ...
    >
      <header
        ...
        }  w-full lg:w-3/5 text-center lg:text-left ml-0 lg:ml-72 mt-12 lg:mt-0`}
      >
        ...
        <p className='text-white text-lg tracking-wide text-justify lg:pb-7'>
          I invite you to join me on this journey of creativity and innovation.
          Let's work together to turn your ideas into outstanding web solutions
